...
const InputArea: FC<TInputAreaProps> = ({
  ...
  <div className="relative py-6 w-full mx-auto">
    ...
    >
        ...
        className="py-6 px-10 ml-1 w-full text bg-gray-300 border-none rounded-md focus:ring focus:ring-blue-500"
        disabled={disabled}
        value={promptValue}
        required
      ...
      <button
          type="button"
          className="px-0 ml-2 outline outline-offset-2 bg-gray-500 mt-2 mb-2 rounded-md hover:bg-gray-400"
      ...
      <button
          type="button"
          className="mb-2 ml-2 mt-2 relative outline outline-offset-2 flex px-2 h-[50px] w-[50px] items-center justify-center rounded-md bg-gray-500 hover:bg-gray-400"
          onClick={handleMicClick}
        >
          <Image
          unoptimized
            src={isRecording ? "/img/stop-icon.svg" : "/img/microphone-icon.svg"}
      ...
      {isSourcesOpen && (
        <div className="fixed inset-1 px-4 py-10 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-black text-white p-10 rounded-lg max-w-md w-full">
            <h2 className="text-xl font-bold bg-slate-600 rounded-md px-2 mb-4">Select Files</h2>
            <div className="mb-4">
