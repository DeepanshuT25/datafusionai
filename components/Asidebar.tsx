...
const Asidebar = () => {
  ...
  return (
    <div className="flex h-screen ml-0 rounded-md">
      ...
      >
        <div className="p-8">
          <h2 className="text-xl text-gray-400 underline font-bold mb-4">Table Browser</h2>
          <div className="mb-8">
            <input
              type="text"
          ...
          <div className="space-y-4">
            {filteredFiles.map((file, index) => (
              <div key={index} className="p-2 bg-black font-semibold text-gray-400 hover:bg-slate-600 hover:text-white cursor-pointer rounded shadow">
                {file}
              </div>
            ))}
          </div>
